...
| [kv_module.md](kv_module.md) | The key/value store: the verbs, the file, the six rulings, what guards the write, every refusal, what its tests and mutants measure |
