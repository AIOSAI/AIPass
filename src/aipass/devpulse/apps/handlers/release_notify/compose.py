...
def compose_body(version: str, headline: list[str]) -> str:
    ...
    parts.extend(
        [
            "Your project scaffold does not update itself, and nothing updates it without your go.",
            ...
            "  3. ask Patrick or devpulse with that plan - apply only on a go",
            "  4. aipass init update <your project root> - applies it",
