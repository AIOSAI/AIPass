...
#   - tmp_path + monkeypatch for file isolation — never the live drone_json/
# =============================================

"""
Durability tests for the drone JSON handler.
...
import aipass.drone.apps.handlers.json.json_handler as json_handler_mod
